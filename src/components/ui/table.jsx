...
function TableHead({
  ...
  return (
    <th
      ...
      className={cn(
        "text-slate-950 h-10 px-2 text-left align-middle font-medium whitespace-nowrap [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px] dark:text-slate-50",
        className
      )}
      {...props} />
  );
...
function TableCaption({
  ...
  return (
    <caption
      ...
      className={cn("text-slate-500 mt-4 text-sm dark:text-slate-400", className)}
      {...props} />
  );
}
